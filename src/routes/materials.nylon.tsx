...
const M = MATERIAL_MAP["nylon"];

export const Route = createFileRoute("/materials/nylon")({
  head: () => ({
    ...seo(M.metaTitle, M.metaDescription, "/materials/nylon"),
    scripts: [
      breadcrumbSchema([
        { name: "Home", path: "/" },
        { name: "Materials", path: "/materials" },
        { name: M.name, path: "/materials/nylon" },
      ]),
    ],
  }),
